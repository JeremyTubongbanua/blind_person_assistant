...
| pitch_yaw_roll | `pi4/pitch_yaw_roll` -> outputs pitch, yaw, and roll values | N/A | Stateless module for calculating the pitch, yaw, and roll of the headset using the raw gyro values. Outputs the calculated values to the MQTT topic. |
